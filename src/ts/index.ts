import { createWalletClient, custom, createPublicClient, parseEther, defineChain, formatEther, WalletClient, PublicClient, Chain } from "viem"
...
const isMetaMaskInstalled: boolean = typeof window.ethereum !== 'undefined'
...
function updateFundButtonState(): void {
    const hasValue: boolean = ethAmountInput.value.trim() !== '' && parseFloat(ethAmountInput.value) > 0
 ...
 * @param client - The wallet client to query for chain information
 * @returns Custom chain configuration object
 */
